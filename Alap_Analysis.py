...
voice, sr = librosa.load(base+"adish_sargam_aroh_b1.wav")
voice1, _ = librosa.load(sar0)
voice2, _ = librosa.load(base+"sargam1.wav")
voice3, _ = librosa.load(base+"sargam2.wav")
voice4, _ = librosa.load(base+"sargam3.wav")
voice5, _ = librosa.load(base+"sargam4.wav")
voice6, _ = librosa.load(base+"sargam5.wav")
voice7, _ = librosa.load(base+"sargam6.wav")
voice8, _ = librosa.load(base+"sargam7.wav")
voice9, _ = librosa.load(base+"sargam8.wav")
voice10, _ = librosa.load(base+"sargam9.wav")
voice11, _ = librosa.load(base+"sargam10.wav")
voice12, _ = librosa.load(base+"sargam11.wav")
voice13, _ = librosa.load(base+"sargam12.wav")
voice14, _ = librosa.load(base+"sargam13.wav")
